          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-700 leading-relaxed">
                Lunar Astro Vedic Academy provides Research-Level Vedic 
                Astrology Consultations & Predictions. Get Expert Vedic guidance 
                on Career, Health, Relationships & more.
              </p>
            </div>
            ...
            <div className="text-center lg:text-right">
              <div className="space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  Join Deepanshu Giri's Telegram for daily astrology insights. Enhance your 
                  success with his expert predictions.
                </p>
                <a 
                  href="#" 
                ...
                >
                  ...
                  Join Deepanshu Sir On WhatsApp
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-center items-center">
            <div className="text-center md:text-center mb-2 md:mb-0">
              <p className="text-sm">
                2025 ©Lunar Astro OPC Pvt. Ltd. All Rights Reserved
              </p>
            </div>
